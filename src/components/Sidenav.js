    ...
    return (
      <div style={sidebarStyle} className="sidenav">
        ...
        <div style={mainNavStyle} className="main-nav">
          <p className="sidebar-icons"><MdOutlineBarChart/>Dashboard</p>
          <p className="sidebar-icons"><PiSquaresFour/>Entity Manager</p>
          <p className="sidebar-icons"><MdPieChartOutlined/>Data Manager</p>
          <p className="sidebar-icons"><img className="sidebar-icon" src={reporting}></img>Reporting</p>
          <p className="sidebar-icons"><img className="sidebar-icon" src={material}></img>Materiality</p>
          <p className="sidebar-icons"><img className="sidebar-icon" src={supplier}></img>Suppliers</p>
          <p className="sidebar-icons"><img className="sidebar-icon" src={analytics}></img>Analytics</p>
          <p className="sidebar-icons"><img className="sidebar-icon" src={targets}></img>Targets</p>
          <p className="sidebar-icons" onClick={logoutHandler}><MdOutlineLogout/> Logout</p>
        </div>
      </div>
    );
  };
